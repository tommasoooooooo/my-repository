async function populate() {
	...
	const requestURL = "https://tommasoooooooo.github.io/my-repository/titanic/titanic.json";
...
function populateCards(obj){
	...
	for (const passenger of members) {
		...
		myDiv.textContent =	`Nome: ${passenger.Name}`;
		myP1.textContent = `Supravissuto: ${passenger.Survived}`;
		myP2.textContent = `Classe: ${passenger.Pclass}`;
		myP3.textContent = `Sesso: ${passenger.Sex}`;
		myP4.textContent = `Anni: ${passenger.Age}`;
		myP5.textContent = `Imbarcati: ${passenger.Embarked}`;
